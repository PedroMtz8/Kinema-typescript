...
import Pricing from "../UserData/Register/Pricing";
...
export default function LandingPage(): JSX.Element {
  ...
  let refMenuBtn = useRef<HTMLObjectElement>(null);
  let list = useRef<HTMLObjectElement>(null);
  let refCloseBtn = useRef<HTMLObjectElement>(null);

  const handleToggleMenu = () => {
    /* const refMenu = refMenuBtn.current
    const refClose = refCloseBtn.current?.id; */
